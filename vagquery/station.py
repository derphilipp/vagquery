...
class StationQuery(object):
    def __init__(self, text):
        ...
        self._url = "http://start.vag.de/dm/api/haltestellen.json/vgn?" + urlencode(
            _parameter
        )
...
class Station(object):
    ...
    def __unicode__(self):
        return "{station_id:5} {vag_name:10} {station_name}".format(
            station_id=self.station_id, vag_name=self.vag_name, station_name=self.name
        )
